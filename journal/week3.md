...
## I made some quality of life changes to the homepage UI via the index.css file. I modified the code in the frontend so that the color pallet appeared more readable and easier to the human eye to deal with:
